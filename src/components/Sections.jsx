        ...
        <div className="max-w-5xl mx-auto bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-10 md:p-16 flex flex-col justify-center">
              ...
              <div className="space-y-4">
                {t.locations.list.map((loc, idx) => (
                  <div
                    key={idx}
                    className="flex items-center p-3 hover:bg-red-50 rounded-xl transition-colors cursor-default group border-b border-gray-50 last:border-0"
                  >
                    <CheckCircle
                      className="text-red-600 mr-4 group-hover:scale-110 transition-transform"
                      size={20}
                    />
                    <div>
            ...
            <div className="bg-gray-100 relative min-h-[300px]">
              <img
                src="https://images.unsplash.com/photo-1599238304323-57350cb175d7?q=80&w=1974&auto=format&fit=crop"
                alt="Map"
